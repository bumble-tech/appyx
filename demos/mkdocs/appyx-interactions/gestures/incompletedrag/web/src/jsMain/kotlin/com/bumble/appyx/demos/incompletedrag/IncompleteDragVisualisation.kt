...
class IncompleteDragVisualisation<InteractionTarget : Any>(
    uiContext: UiContext,
    ...
    companion object {
        ...
        private val bottomRightCorner = TargetUiState(
            positionAlignment = PositionAlignment.Target(BiasAlignment.InsideAlignment.BottomEnd, bottomOffset),
        ...
        private val bottomLeftCorner = TargetUiState(
            positionAlignment = PositionAlignment.Target(BiasAlignment.InsideAlignment.BottomStart, bottomOffset),
