...
class IncompleteDragVisualisation<InteractionTarget : Any>(
    ...
    companion object {
        ...
        private val bottomRightCorner = TargetUiState(
            position = PositionAlignment.Target(BiasAlignment.InsideAlignment.BottomEnd, bottomOffset),
        ...
        private val bottomLeftCorner = TargetUiState(
            position = PositionAlignment.Target(BiasAlignment.InsideAlignment.BottomStart, bottomOffset),
