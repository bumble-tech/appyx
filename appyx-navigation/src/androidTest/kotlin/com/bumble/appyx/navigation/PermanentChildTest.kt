...
import com.bumble.appyx.navigation.PermanentChildTest.TestParentNode.InteractionTarget
...
class PermanentChildTest {
    ...
    class TestParentNode(
        ...
        override fun resolve(navTarget: InteractionTarget, buildContext: BuildContext): Node =
