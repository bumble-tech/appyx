package com.bumble.appyx.components.testdrive.ui.rotation
...
class TestDriveRotationMotionController<InteractionTarget : Any>(
    ...
    companion object {
        ...
        fun TestDriveModel.State.ElementState.toTargetUiState(): TargetUiState =
            when (this) {
                A -> com.bumble.appyx.components.testdrive.ui.rotation.TestDriveRotationMotionController.a
                B -> com.bumble.appyx.components.testdrive.ui.rotation.TestDriveRotationMotionController.b
                C -> com.bumble.appyx.components.testdrive.ui.rotation.TestDriveRotationMotionController.c
                D -> com.bumble.appyx.components.testdrive.ui.rotation.TestDriveRotationMotionController.d
            }
